...
public class UserPrinciple implements UserDetails {
  ...
  public UserPrinciple(Long id, String name, String username, String email, String password,
      String avartar, Collection<? extends GrantedAuthority> roles) {
    super();
    this.id = id;
    this.name = name;
    this.username = username;
  ...
  public static UserPrinciple build(User user) {
    ...
    return new UserPrinciple(user.getId(), user.getName(), user.getUsername(),user.getEmail(), user.getPassword(), user.getAvartar(), authorities);
  }
